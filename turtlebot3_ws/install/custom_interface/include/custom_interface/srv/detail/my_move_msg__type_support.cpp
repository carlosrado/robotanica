...
{
  new (message_memory) custom_interface::srv::MyMoveMsg_Request(_init);
}

void MyMoveMsg_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interface::srv::MyMoveMsg_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MyMoveMsg_Request_message_member_array[1] = {
  {
    ...
    offsetof(custom_interface::srv::MyMoveMsg_Request, move),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MyMoveMsg_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interface::srv::MyMoveMsg_Request),
...
{
  return &::custom_interface::srv::rosidl_typesupport_introspection_cpp::MyMoveMsg_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interface, srv, MyMoveMsg_Request)() {
  return &::custom_interface::srv::rosidl_typesupport_introspection_cpp::MyMoveMsg_Request_message_type_support_handle;
}
...
void MyMoveMsg_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) custom_interface::srv::MyMoveMsg_Response(_init);
}

void MyMoveMsg_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interface::srv::MyMoveMsg_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MyMoveMsg_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interface::srv::MyMoveMsg_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MyMoveMsg_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interface::srv::MyMoveMsg_Response),
...
{
  return &::custom_interface::srv::rosidl_typesupport_introspection_cpp::MyMoveMsg_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interface, srv, MyMoveMsg_Response)() {
  return &::custom_interface::srv::rosidl_typesupport_introspection_cpp::MyMoveMsg_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers MyMoveMsg_service_members = {
  ...
  // see get_service_type_support_handle<custom_interface::srv::MyMoveMsg>()
...
get_service_type_support_handle<custom_interface::srv::MyMoveMsg>()
{
  ...
  auto service_type_support =
    &::custom_interface::srv::rosidl_typesupport_introspection_cpp::MyMoveMsg_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interface, srv, MyMoveMsg)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<custom_interface::srv::MyMoveMsg>();
}
